...
void Laborator2::Init()
{
	...
	// Create a mesh piramida
	{
		...
		meshes["forma"] = new Mesh("generated forma");
		meshes["forma"]->InitFromData(vertices1, indices1);

		// Create a new mesh from buffer data
		Mesh* cube = CreateMesh("cube2", vertices1, indices1);
...

	{
		...
		meshes["patrat"]->InitFromData(vertices2, indices2);

		// Create a new mesh from buffer data
		Mesh* cube = CreateMesh("patrat", vertices2, indices2);
	}
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(2, 2, 0), glm::vec3(0.5f));
	RenderMesh(meshes["forma"], shaders["VertexColor"], glm::vec3(3, 3, 0), glm::vec3(1));
	RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(2, -1, 0.5f), glm::vec3(1));
