...
void Laborator3::Init()
{
	...
	//glm::vec3 corner1 = glm::vec3(10, 25,0);
	//glm::vec3 corner2 = glm::vec3(0, 25, 0);
...
void Laborator3::Update(float deltaTimeSeconds)
{
	...
	modelMatrix *= Transform2D::Translate(40*sin(translateX/10), 1);
	...
	modelMatrix *= Transform2D::Scale(sin(translateX/100), sin(translateY/100));
	...
	modelMatrix *= Transform2D::Rotate(translateX/10);
	modelMatrix *= Transform2D::Translate(-50,-50);
